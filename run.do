...
*   "Field evidence on termination from payments for ecosystem services: Cundinamarca, Colombia"
*	Authors: Esther Blanco, Alex Pfaff, Björn Vollan, Ivo Steimanis
...
global working_ANALYSIS "D:\OneDrive\Promotion\1_Projects\PES_Colombia\replication_package"
